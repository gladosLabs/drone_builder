        ...
        <div className="flex items-center space-x-4">
          ...
          {router.pathname === "/playground" && (
            <div className="flex items-center space-x-2 relative">
              ...
              <div
                ...
                tabIndex={-1}
              >
                <div className="w-72 bg-white border rounded shadow-lg mt-40">
          ...
          <div className="flex items-center space-x-2">
            {user ? (
              ...
              <>
                <Link href="/login" className="px-4 py-2 rounded-lg bg-gray-100 text-gray-700 font-medium hover:bg-gray-200 transition">
                  Login
                </Link>
