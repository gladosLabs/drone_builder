        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex items-center justify-center space-x-4">
              <Link
                href="/ai-assistant"
                className="px-6 py-3 bg-gradient-to-r from-[#8b95c9] to-[#84dcc6] text-white rounded-xl font-medium hover:shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center space-x-2"
              >
